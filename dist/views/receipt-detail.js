...
exports.ReceiptDetailPanel = void 0;
const vscode = __importStar(require("vscode"));
const crypto = __importStar(require("crypto"));
class ReceiptDetailPanel {
    static currentPanel;
    panel;
    disposables = [];
    constructor(panel, _extensionUri, receipt, verification) {
        this.panel = panel;
        this.panel.onDidDispose(() => this.dispose(), null, this.disposables);
        this.panel.webview.html = this.getHtml(receipt, verification);
    }
    static createOrShow(extensionUri, receipt, verification) {
        ...
        const panel = vscode.window.createWebviewPanel("maip.receiptDetail", `Receipt: ${receipt.id.substring(0, 8)}`, column ?? vscode.ViewColumn.One, {
            enableScripts: true,
            retainContextWhenHidden: true,
        });
        ReceiptDetailPanel.currentPanel = new ReceiptDetailPanel(panel, extensionUri, receipt, verification);
    }
    dispose() {
    ...
    getHtml(receipt, verification) {
        ...
        const warnings = verification.warnings.length > 0
...
exports.ReceiptDetailPanel = ReceiptDetailPanel;
...
//# sourceMappingURL=receipt-detail.js.map